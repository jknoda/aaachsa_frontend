...
import { init, create, update, remove } from './pessoaActions'

import List from './pessoaList'
...
class Pessoa extends Component {
    ...
    render() {
        return (
            <div>
                <ContentHeader title='Pessoas' small='Cadastro' />
                <Content>
                    <Tabs>
                        <TabsHeader>
...
export default connect(null, mapDispatchToProps)(Pessoa)
