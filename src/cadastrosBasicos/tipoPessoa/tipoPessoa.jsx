...
import { create, update, remove } from './tipoPessoaActions'

import List from './tipoPessoaList'
import Form from './tipoPessoaForm'
...
class TipoPessoa extends Component {
    ...
    render() {
        return (
            <div>
                <ContentHeader title='Tipo pessoa' small='Cadastro básico' />
                <Content>
                    <Tabs>
                        <TabsHeader>
...
export default connect(null, mapDispatchToProps)(TipoPessoa)
