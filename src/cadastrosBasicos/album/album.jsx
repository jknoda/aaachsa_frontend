...
import { init, create, update, remove } from './albumActions'

import List from './albumList'
...
class Albuns extends Component {
    ...
    render() {
        return (
            <div>
                <ContentHeader title='Albuns' small='Cadastro básico' />
                <Content>
                    <Tabs>
                        <TabsHeader>
...
export default connect(null, mapDispatchToProps)(Albuns)
